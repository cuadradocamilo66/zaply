...
export default function FreeTemplatesSection({ templates = [] }: FreeTemplatesSectionProps) {
    ...
    return (
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold">Plantillas Gratuitas</h2>
        ...
        <p className="text-muted-foreground">No hay plantillas gratuitas disponibles en este momento.</p>
      </div>
    )
  }
